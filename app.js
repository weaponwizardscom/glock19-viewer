document.addEventListener('DOMContentLoaded', async () => {
    ...
    const PARTS_TO_CONFIGURE = [
        ...
        { id: 'spust',    pl: 'Język spustowy z szyną', en: 'Trigger with trigger bar', textureFile: 'spust.png' },
        { id: 'lufa',     pl: 'Lufa', en: 'Barrel', textureFiles: ['lufa1', 'lufa2'] }, // Grupowanie
    ...
    try {
        ...
        // Grupowanie lufy w jedną całość
        ...
        if(lufaPaths.length > 0) {
            lufaPaths[0].parentNode.insertBefore(lufaGroup, lufaPaths[0]);
        ...
        PARTS_TO_CONFIGURE.forEach(part => {
            ...
            if (!originalPath) { console.warn(`Nie znaleziono części o ID: ${part.id}`); return; }
            ...
            button.dataset.partId = part.id; // Przechowujemy ID do identyfikacji
